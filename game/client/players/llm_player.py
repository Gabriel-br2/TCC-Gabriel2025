from game.llm.agent import AgentPlayer
from game.llm.agent import AgentSummary
from game.llm.agent import AgentThinker
...
class LLMPlayer:
    def __init__(self, timestamp, client_id, cfg, source="local", memory_path=None):
        ...
        self.logger = LLMSessionLogger(timestamp, client_id)

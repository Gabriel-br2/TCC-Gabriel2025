...
class TeeweeShape:
    ...
    def __init__(self, screen, color, initial_position, cfg, space=None):
        ...
        self.shape1 = pymunk.Poly(self.body, self.vertices1)  # Create the first rectangle shape
        self.shape2 = pymunk.Poly(self.body, self.vertices2)  # Create the second rectangle shape
